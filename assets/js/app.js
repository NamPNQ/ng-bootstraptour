angular.module("myApp",["ui.bootstrap.tour"])
    .controller("TourDemoController",["$scope,$tour",function($scope,$tour){
        var tourInstance = $tour.Tour();
        tourInstance.addSteps([
            {
                element: "#download",
                placement: "bottom",
    ...
    .controller("TourInstanceCtrl",["$scope",function($scope){
